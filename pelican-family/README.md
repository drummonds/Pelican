...
This is a Bootstrap 3 theme for Pelican.  It has been forked from 
pelican-boostrap3 as I have more heavily customised it. It's fully responsive. Pelican-bootstrap3 is compatible with Pelican 3.3.0 and 
...
### Category heading pages
If you have a page category-landing.html  Then that page will appear
first on the category list.
